...
tables["shipment_scan_event"] = FlowConfig(
    ...
    zones={
        "bronze": StageConfig(
            enabled=True, mode="append", custom_transform="explode_message_payload"
        ),
        "silver": StageConfig(
            enabled=True,
            mode="append",
...
def silver_order_transformer(df) -> DataFrame:
    df = (
        ...
        .withColumn("order_lines", sf.explode_outer("order_lines"))
        .select("*", "order_lines.*")
                                ...
                                ArrayType(
                                    StructType(
                                        [
                                            ...
                                            StructField(
                                                "ExtendedPrice", DoubleType(), True
                                            ),
                                            StructField("ItemId", StringType(), True),
                                            StructField("LineNumber", LongType(), True),
                                            StructField(
                                                "NetWeight", DoubleType(), True
                                            ),
                                            StructField("Quantity", LongType(), True),
                                            StructField("SKU", StringType(), True),
                                            StructField(
                                                "UnitPrice", DoubleType(), True
                                            ),
                                            StructField(
                                                "WarrantyIncluded", BooleanType(), True
                                            ),
                                        ]
                                    ),
                                    True,
...
tables["customer"] = FlowConfig(
    ...
    schema=StructType(
        [
            ...
            StructField("CustomerName", StringType(), True),
            StructField("Description", StringType(), True),
            StructField("PrimaryContactFirstName", StringType(), True),
            StructField("PrimaryContactLastName", StringType(), True),
...
tables["route"] = FlowConfig(
    ...
    schema=StructType(
        [
            ...
            StructField("TravelTimeHours", DoubleType(), True),
            StructField("OrganizationId", LongType(), True),
            StructField("GeneratedAt", StringType(), True),
        ]
    ),
